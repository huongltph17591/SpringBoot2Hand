            ...
            <form:form  action="/shoppingcart/save/order"  modelAttribute="item">
                <div class="row">
                    <div class="col-md-12 mb-6">
                        ...
                        <input type="text" class="form-control" id="fullname" placeholder="" value="${account.fullname}" />
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <form:input type="text" class="form-control"  placeholder="" value="${account.id}" path="account.id" />
